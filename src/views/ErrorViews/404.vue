  ...
  <div class="notfound-wrap">
    <div class="wscn-http404">
      ...
      <div class="bullshit">
        ...
        <div class="bullshit__headline">{{ $t('view404.title') }}</div>
        <!-- <div class="bullshit__info">{{ $t('view404.tip') }}</div>
        <router-link :to="{name: 'home'}" class="bullshit__return-home">{{ $t('view404.backToHome') }}</router-link> -->
      </div>
    </div>
  </div>
</template>
